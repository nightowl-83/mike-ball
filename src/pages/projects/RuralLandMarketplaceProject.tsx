...
const RuralLandMarketplaceProject = () => {
  ...
  const scrollGallerySlides = [
    ...
    },
    {
      ...
      title: "Map Layers",
      description:
        "Toggle between satellite, terrain, and custom overlays to visualize property boundaries and features.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="absolute top-4 left-4 md:top-6 md:left-6 z-50">
          <Link to="/">
            <Button
              variant="ghost"
              size="sm"
              className="gap-2 bg-background/20 backdrop-blur-md hover:bg-background/40 text-foreground text-xs md:text-sm"
            >
        ...
        <div className="flex flex-col md:flex-row h-full">
          ...
          <div className="w-full md:w-1/2 flex items-center px-6 md:px-12 lg:px-20 bg-card py-12 md:py-0 mx-0 my-0">
            <div className="space-y-4 md:space-y-6 animate-fade-in max-w-2xl">
              ...
              <p className="text-base md:text-lg lg:text-xl text-muted-foreground">
                A complete relaunch of Costar's Rural Land Marketplace, reimagining the property search experience with
                modern design and intuitive map integration.
              </p>
          ...
          <div className="w-full md:w-1/2 h-64 md:h-full relative">
            <img
              ...
              className="w-[95%] h-[95%] object-contain mx-auto my-auto"
            />
          </div>
        </div>
      </section>
      ...
      <div className="relative -mt-[10vh] z-10 bg-background">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-start">
              <div className="space-y-4 md:space-y-6">
                ...
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                  Costar's Rural Land Marketplace was the go-to platform for buyers and sellers of rural properties,
                  farms, and large land parcels. However, the platform's interface had become outdated and cumbersome to
                  navigate.
                </p>
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                  The search functionality was complex, the map integration felt disconnected, and the mobile experience
                  was almost non-existent. Our team was tasked with a complete relaunch that would modernize the
                  platform while maintaining the robust features that users relied on.
                </p>
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                  Through comprehensive user research and iterative design, we delivered a solution that increased
                  property views by 45% and improved mobile engagement by 60%.
                </p>
              </div>
              <div className="space-y-4 md:space-y-6">
                ...
                <ul className="space-y-4 md:space-y-6 text-base md:text-lg text-muted-foreground">
                  <li className="flex items-start gap-3 md:gap-4">
                    ...
                    <span>
                      Comprehensive redesign of search and filter functionality for intuitive property discovery.
                    </span>
                  </li>
                  <li className="flex items-start gap-3 md:gap-4">
                    <span className="w-2 h-2 rounded-full bg-primary mt-2.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-3 md:gap-4">
                    <span className="w-2 h-2 rounded-full bg-primary mt-2.5 flex-shrink-0" />
                    <span>
                      User testing with real estate professionals and land buyers to validate design decisions.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section
          ref={productShotsAnim.ref}
          className={`py-24 transition-all duration-700 ${productShotsAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          <div className="container mx-auto max-w-[1440px]">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="w-full aspect-[4/5] rounded-2xl overflow-hidden shadow-card">
                <img
                  src={landPromoDesktop}
                  alt="Land.com Find Your Open Space promotional banner"
        ...
        <section
          ref={processAnim.ref}
          className={`min-h-screen flex items-center justify-center py-10 md:py-24 bg-card/30 transition-all duration-700 ${processAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-start">
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <p className="text-base md:text-xl text-muted-foreground">
                  A structured approach combining competitive analysis, user research, and iterative design to deliver a
              ...
              <div className="space-y-0">
                ...
                <div className="flex gap-4 md:gap-10 pb-6 md:pb-8 border-b border-border">
                  <div className="text-xl md:text-2xl lg:text-3xl font-bold font-mono text-primary flex-shrink-0">
                    /01
                  </div>
        ...
        {/* Define Section - 01 */}
        <section
          ref={defineContentAnim.ref}
          className={`relative py-10 md:py-24 transition-all duration-700 ${defineContentAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          ...
          <div className="container mx-auto max-w-[1440px]">
            <div className="flex items-baseline justify-between mb-4 md:mb-16">
              ...
              <span className="text-xl md:text-6xl lg:text-7xl font-bold font-mono opacity-20 text-right shrink-0">
                /01
              </span>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-16">
              ...
              <div className="space-y-4 md:space-y-12">
                <p className="text-base md:text-xl text-muted-foreground">
                  Analysis of the existing Rural Land Marketplace revealed key features users valued most, along with
              ...
              <div className="space-y-4 md:space-y-12">
                <div className="space-y-4 md:space-y-6 text-base md:text-lg text-muted-foreground">
                  <p>
                    <strong className="text-primary">Search Functionality:</strong> Users relied on search filters for
                    property type, acreage, price, and location, but the interface was cluttered and confusing.
                  </p>

                  <p>
                    <strong className="text-primary">Map View:</strong> The map was a critical tool for browsing
                    properties by location, but it felt disconnected from the main search experience.
                  </p>

                  <p>
                    <strong className="text-primary">Property Listings:</strong> Detailed listings provided
                    comprehensive information, but navigation between views was cumbersome.
                  </p>

                  <p>
                    <strong className="text-primary">Mobile Experience:</strong> Nearly unusable on mobile devices,
                    despite a growing number of users accessing the platform on phones and tablets.
                  </p>
                  ...
                  <div className="p-4 md:p-6 rounded-xl bg-card/50 border-2 border-primary/20">
                    ...
                    <p className="mt-2">
                      Prioritize mobile-first design and seamless integration between search and map views.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div ref={defineGalleryRef} className="mt-8 md:mt-32">
              <h3 className="text-lg md:text-xl text-muted-foreground mb-6 md:mb-8">
                Brainstorming, Competitor Analysis, Pain Points
              </h3>
              ...
              <div className="hidden md:grid grid-cols-12 gap-4 auto-rows-[140px] lg:auto-rows-[180px]">
                ...
                <button
                  ...
                  className="col-span-7 row-span-2 rounded-2xl overflow-hidden shadow-card animate-fade-in hover:scale-[1.02] transition-transform cursor-pointer"
                >
                ...
                <button
                  ...
                  className="col-span-5 row-span-3 rounded-2xl overflow-hidden shadow-card animate-fade-in hover:scale-[1.02] transition-transform cursor-pointer"
                ...
                <button
                  ...
                  className="col-span-4 row-span-1 rounded-2xl overflow-hidden shadow-card animate-fade-in hover:scale-[1.02] transition-transform cursor-pointer"
                ...
                <button
                  ...
                  className="col-span-3 row-span-1 rounded-2xl overflow-hidden shadow-card animate-fade-in hover:scale-[1.02] transition-transform cursor-pointer"
        ...
        <section className="relative py-10 md:py-24 bg-card/30">
          ...
          <div className="container mx-auto max-w-[1440px]">
            ...
            <div
              ref={discoveryInterviewsRef}
              className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-16 mb-8 md:mb-32 items-stretch"
            >
              ...
              <div className="flex flex-col justify-between h-full">
                <div>
                  ...
                  <p className="text-xl text-muted-foreground leading-relaxed">
                    We surveyed <strong className="text-primary">45</strong> land buyers and sellers about their
                    property search experience. <strong className="text-primary">38</strong> responded with insights
                    that guided our redesign.
                  </p>
                </div>
              </div>
              ...
              <div
                ref={discoveryStatsAnim.ref}
                className={`lg:col-span-2 space-y-4 md:space-y-8 transition-all duration-700 ${discoveryStatsAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
              >
                {/* Statistics */}
                <div className="flex flex-col md:grid md:grid-cols-3 gap-6 md:gap-8 pt-4 md:pt-8 items-center">
                  ...
                  <div className="text-center">
                    <svg
                      className="w-32 h-32 md:w-40 md:h-40 mx-auto mb-6 transition-all duration-700 hover:scale-110"
                      viewBox="0 0 160 160"
                    >
                      <defs>
                      ...
                      <circle
                        ...
                        r="70"
                        fill="none"
                        stroke="url(#gradient1-rural)"
                        strokeWidth="8"
                        strokeDasharray="439.8"
                        strokeDashoffset={439.8 * (1 - 0.28)}
                        strokeLinecap="round"
                        transform="rotate(-90 80 80)"
                        filter="url(#glow1-rural)"
                      />
                      <text
                        x="80"
                        y="75"
                      ...
                      <text x="80" y="95" textAnchor="middle" className="text-xs" fill="hsl(var(--muted-foreground))">
                        Satisfied
                      </text>
                    </svg>
                    <p className="text-sm text-muted-foreground max-w-[200px] mx-auto">
                      Users satisfied with current search experience
                    </p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    >
                      ...
                      <circle
                        ...
                        r="70"
                        fill="none"
                        stroke="url(#gradient2-rural)"
                        strokeWidth="8"
                        strokeDasharray="439.8"
                        strokeDashoffset={439.8 * (1 - 0.65)}
                        strokeLinecap="round"
                        transform="rotate(-90 80 80)"
                        filter="url(#glow2-rural)"
                      />
                      <text
                        x="80"
                        y="75"
                    ...
                    <p className="text-sm text-muted-foreground max-w-[200px] mx-auto">
                      Users accessing platform on mobile devices
                    </p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    >
                      ...
                      <circle
                        ...
                        r="70"
                        fill="none"
                        stroke="url(#gradient3-rural)"
                        strokeWidth="8"
                        strokeDasharray="439.8"
                        strokeDashoffset={439.8 * (1 - 0.82)}
                        strokeLinecap="round"
                        transform="rotate(-90 80 80)"
                        filter="url(#glow3-rural)"
                      />
                      <text
                        x="80"
                        y="75"
                    ...
                    <p className="text-sm text-muted-foreground max-w-[200px] mx-auto">
                      Users relying on map view for property search
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div
              ref={quotesAnim.ref}
              className={`space-y-6 md:space-y-8 transition-all duration-700 ${quotesAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className="bg-card rounded-xl p-6 md:p-8 border border-border">
                  <p className="text-base md:text-lg text-muted-foreground italic mb-4">
                    "The search filters are so confusing. I just want to find land near me, but I have to click through
                    so many options."
                  </p>
                ...
                <div className="bg-card rounded-xl p-6 md:p-8 border border-border">
                  <p className="text-base md:text-lg text-muted-foreground italic mb-4">
                    "I love the map view, but it feels separate from everything else. I wish I could search directly on
                    the map."
                  </p>
                ...
                <div className="bg-card rounded-xl p-6 md:p-8 border border-border">
                  <p className="text-base md:text-lg text-muted-foreground italic mb-4">
                    "On my phone, it's almost impossible to use. The buttons are too small and the layout doesn't fit my
                    screen."
                  </p>
            ...
            <div ref={discoveryPersonaRef} className="mt-12 md:mt-20">
              <div
                ref={personaAnim.ref}
                className={`transition-all duration-700 ${personaAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6 max-w-6xl mx-auto">
                  ...
                  <div className="bg-card rounded-2xl p-10 shadow-sm flex flex-col justify-center">
                    ...
                    <p className="text-base text-muted-foreground leading-relaxed">
                      Carlos is looking for a seamless way to discover and explore land properties through an intuitive,
                  ...
                  <div className="bg-card rounded-2xl p-8 shadow-sm flex items-center">
                    <p className="text-xl text-muted-foreground leading-relaxed italic">
                      "I need to easily search properties on a map from my phone, with better filters and image
                      galleries that actually work well."
                    </p>
                  </div>
                </div>
              </div>
        ...
        {/* Design Section - 03 */}
        <section
          ref={designContentAnim.ref}
          className={`relative py-10 md:py-24 transition-all duration-700 ${designContentAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-16">
              ...
              <div className="space-y-4 md:space-y-12">
                <p className="text-xl text-muted-foreground">
                  Creating a seamless, map-centric experience that simplifies property search and works beautifully on
                  any device.
                </p>
              </div>
              ...
              <div className="space-y-4 md:space-y-12">
                <div className="space-y-4 md:space-y-6 text-base md:text-lg text-muted-foreground">
                  <p>
                    <strong className="text-foreground">Map-First Interface:</strong> Redesigned the entire experience
                    around the map view, making it the primary way users discover and explore properties.
                  </p>

                  <p>
                    <strong className="text-foreground">Simplified Search:</strong> Streamlined filters with smart
                    defaults and progressive disclosure, reducing cognitive load while maintaining power user
                    capabilities.
                  </p>

                  <p>
                    <strong className="text-foreground">Responsive Design:</strong> Built mobile-first with
                    touch-optimized controls and adaptive layouts that work seamlessly across all devices.
                  </p>

                  <p>
                    <strong className="text-foreground">Visual Refinement:</strong> Modern, clean aesthetic with
                    improved typography, spacing, and visual hierarchy for better scannability.
                  </p>
        ...
        <div className="viewport-image-section">
          ...
          <img
            ...
            className="hidden lg:block w-full h-full object-cover object-left-top"
          />
              ...
              <div className="flex flex-col gap-4 md:gap-6">
                ...
                <div className="bg-card border border-border rounded-lg p-4 md:p-6 flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-2 md:gap-3 flex-1">
                    <div
                      className="rounded-lg p-4 flex items-end row-span-2"
                      style={{
                    ...
                    <div
                      className="rounded-lg p-4 flex items-end"
                      style={{
        ...
        {/* Delivery Section - 04 */}
        <section
          ref={deliveryContentAnim.ref}
          className={`relative py-10 md:py-24 bg-card/30 transition-all duration-700 ${deliveryContentAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          ...
          <div className="container mx-auto max-w-[1440px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-16">
              ...
              <div className="space-y-4 md:space-y-12">
                <p className="text-xl text-muted-foreground">
                  Implementing a comprehensive design system and ensuring seamless handoff to development teams for a
                  successful relaunch.
                </p>
              </div>
              ...
              <div className="space-y-4 md:space-y-12">
                <div className="space-y-4 md:space-y-6 text-base md:text-lg text-muted-foreground">
                  <p>
                    <strong className="text-foreground">Design System:</strong> Created a comprehensive design system
                    with reusable components, ensuring consistency across the entire platform.
                  </p>

                  <p>
                    <strong className="text-foreground">Developer Handoff:</strong> Provided detailed Figma files with
                    design specs, component libraries, and interactive prototypes for smooth implementation.
                  </p>

                  <p>
                    <strong className="text-foreground">Quality Assurance:</strong> Conducted extensive testing across
                    devices, browsers, and screen sizes to ensure flawless execution.
                  </p>

                  <p>
                    <strong className="text-foreground">Launch Support:</strong> Worked closely with the development
                    team during the rollout to address edge cases and refine interactions.
                  </p>
                  ...
                  <div className="p-6 rounded-xl bg-card/50 border-2 border-primary/20">
                    ...
                    <p className="mt-2">
                      User testing reports with insights and recommendations for continuous improvement.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="w-full">
          ...
          <div className="relative w-full flex justify-center bg-background overflow-hidden">
            <video
              ...
              playsInline
              preload="auto"
              className={`w-full h-[75vh] md:h-auto max-h-[75vh] md:max-h-[600px] lg:max-h-[680px] lg:w-auto object-cover object-[16%_center] scale-[0.8] md:object-[20%_center] md:scale-100 lg:object-contain lg:scale-100 lg:mx-auto transition-opacity duration-500 ${videoReady ? "opacity-100" : "opacity-0"}`}
            />
            ...
            <div
              className="hidden lg:block absolute top-0 right-0 bottom-0 w-6 z-20"
        ...
        <section className="relative py-10 md:py-24 bg-card/30">
          ...
          <div className="container mx-auto max-w-[1440px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-16">
              ...
              <div className="space-y-4 md:space-y-12">
                <p className="text-base md:text-xl text-muted-foreground">
                  The redesign focused on two critical user journeys: discovering properties through search and
                  evaluating individual listings through detailed property pages.
                </p>
              </div>
              ...
              <div className="space-y-4 md:space-y-12">
                <div className="space-y-4 md:space-y-6 text-base md:text-lg text-muted-foreground">
                  <p>
                    <strong className="text-primary">Search Experience:</strong> A complete reimagining of how users
                    find and filter properties, with map-first design and intuitive controls.
                  </p>

                  <p>
                    <strong className="text-primary">Details Page:</strong> Comprehensive property information presented
                    in a scannable, visually rich format that drives engagement and inquiries.
                  </p>

                  <div className="p-4 md:p-6 rounded-xl bg-card/50 border-2 border-primary/20">
                    <h3 className="text-lg md:text-xl font-bold text-foreground mb-3 md:mb-4">Design Philosophy</h3>
                    <p>
                      Both components were designed mobile-first, prioritizing touch interactions and quick scanning.
                    </p>
                    <p className="mt-2">
                      Visual hierarchy guides users from discovery through to inquiry with minimal friction.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="relative py-10 md:py-24 bg-background">
          <div className="container mx-auto max-w-[1440px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-16">
              ...
              <div className="space-y-4 md:space-y-12">
                <p className="text-base md:text-xl text-muted-foreground">
                  The new search experience became the cornerstone of the platform redesign, prioritizing speed,
                  clarity, and seamless integration with map browsing.
                </p>
              </div>
              ...
              <div className="space-y-4 md:space-y-12">
                <div className="space-y-4 md:space-y-6 text-base md:text-lg text-muted-foreground">
                  <p>
                    <strong className="text-primary">Simplified Filters:</strong> Streamlined search controls for
                    property type, acreage, price range, and location with an intuitive interface that reduces cognitive
                    load.
                  </p>

                  <p>
                    <strong className="text-primary">Map-First Approach:</strong> Integrated search directly into the
                    map view, allowing users to draw search boundaries, explore by region, and see results in real-time.
                  </p>

                  <p>
                    <strong className="text-primary">Mobile-Optimized:</strong> Touch-friendly controls and gestures
                    designed specifically for mobile devices, with quick filters accessible via bottom sheet navigation.
                  </p>

                  <p>
                    <strong className="text-primary">Smart Suggestions:</strong> Auto-complete and location-based
                    suggestions help users find properties faster, with saved searches and alerts for new listings.
                  </p>

                  <div className="p-4 md:p-6 rounded-xl bg-card/50 border-2 border-primary/20">
                    <h3 className="text-lg md:text-xl font-bold text-foreground mb-3 md:mb-4">Key Impact</h3>
                    <p>
                      Search satisfaction increased from 28% to 76%, with users completing property searches 40% faster
                      on average.
                    </p>
                    <p className="mt-2">
                      Mobile search engagement grew by 85%, making it the primary way users discovered properties.
                    </p>
                  </div>
                </div>
              </div>
                      ...
                      {scrollGallerySlides.map((slide, index) => (
                        <div
                          ...
                          className={cn(
                            ...
                            currentSlide === index ? "opacity-100 scale-100" : "opacity-0 scale-[0.98]",
                          )}
                        >
                    ...
                    <div className="lg:col-span-1 flex flex-col justify-center space-y-6">
                      ...
                      <div className="flex gap-2">
                        <button
                          onClick={() => {
                            const prevSlide =
                              (currentSlide - 1 + scrollGallerySlides.length) % scrollGallerySlides.length;
        ...
        <section className="relative py-10 md:py-24 bg-card/30">
          ...
          <div className="container mx-auto max-w-[1440px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-16">
              ...
              <div className="space-y-4 md:space-y-12">
                <p className="text-base md:text-xl text-muted-foreground">
                  The property details page serves as the central hub for buyers to explore listings, view imagery, and
                  make informed decisions about their land purchase.
                </p>
              </div>
              ...
              <div className="space-y-4 md:space-y-12">
                <div className="space-y-4 md:space-y-6 text-base md:text-lg text-muted-foreground">
                  <p>
                    <strong className="text-primary">Immersive Gallery:</strong> Full-screen photo galleries with
                    satellite views, topographic maps, and drone footage to give buyers a complete picture of the
                    property.
                  </p>

                  <p>
                    <strong className="text-primary">Key Details at a Glance:</strong> Property size, zoning, utilities,
                    road access, and terrain features displayed prominently for quick scanning.
                  </p>

                  <p>
                    <strong className="text-primary">Interactive Maps:</strong> Boundary overlays, neighboring parcels,
                    and distance to key amenities help buyers understand the property context.
                  </p>

                  <p>
                    <strong className="text-primary">Contact & Inquiry:</strong> Streamlined contact forms and saved
                    property features make it easy for interested buyers to take the next step.
                  </p>

                  <div className="p-4 md:p-6 rounded-xl bg-card/50 border-2 border-primary/20">
                    <h3 className="text-lg md:text-xl font-bold text-foreground mb-3 md:mb-4">Design Focus</h3>
                    <p>
                      Prioritize visual storytelling while ensuring critical property information is always accessible.
                    </p>
                    <p className="mt-2">
                      Balance comprehensive details with clean, scannable layouts optimized for mobile.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="callout-section relative w-full overflow-visible">
          ...
          <div ref={callout1Ref} className="relative z-30 pb-8 md:pb-12 overflow-visible">
            <div className="container mx-auto max-w-[1440px] px-4 md:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 lg:gap-4 items-center">
                ...
                <div
                  className={`lg:col-span-8 order-1 flex justify-center lg:justify-end items-center transition-all duration-700 ease-out ${callout1Visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
                >
                  <img
                    src={ldpCallout1}
                  ...
                  <div className="hidden lg:flex items-center -ml-[33%] relative z-10">
                    ...
                    <div className="callout-line flex-1 min-w-[200px]" />
                  </div>
                </div>

                {/* Text Column (Right) - 1/3 width */}
                <div
                  className={`lg:col-span-4 order-2 flex items-center transition-all duration-700 delay-200 ease-out ${callout1Visible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}
                >
          ...
          <div
            ref={callout2Ref}
            className="relative z-20 -mt-24 md:-mt-32 lg:-mt-64 pt-4 pb-8 md:pt-8 md:pb-12 overflow-visible"
          >
            <div className="container mx-auto max-w-[1440px] px-4 md:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 lg:gap-4 items-center">
                {/* Text Column (Left) - 1/3 width */}
                <div
                  className={`lg:col-span-4 order-2 lg:order-1 flex items-center justify-end transition-all duration-700 delay-200 ease-out ${callout2Visible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}
                >
                ...
                <div
                  className={`lg:col-span-8 order-1 lg:order-2 flex justify-center lg:justify-start items-center transition-all duration-700 ease-out ${callout2Visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
                >
                  {/* Callout connector on image side - extends to center of image */}
          ...
          <div
            ref={callout3Ref}
            className="relative z-10 -mt-24 md:-mt-32 lg:-mt-64 pt-8 md:pt-12 lg:pt-32 pb-8 md:pb-12 overflow-visible"
          >
            <div className="container mx-auto max-w-[1440px] px-4 md:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 lg:gap-4 items-center">
                {/* Image Column (Left) with callout - 2/3 width */}
                <div
                  className={`lg:col-span-8 order-1 flex justify-center lg:justify-end items-center transition-all duration-700 ease-out ${callout3Visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
                >
                  <img
                    src={ldpCallout3}
                ...
                {/* Text Column (Right) - 1/3 width */}
                <div
                  className={`lg:col-span-4 order-2 flex items-center transition-all duration-700 delay-200 ease-out ${callout3Visible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}
                >
                  <div className="lg:pl-4 p-4 lg:p-0 rounded-lg bg-background/80 lg:bg-transparent backdrop-blur-sm lg:backdrop-blur-none max-w-md">
                    <h4 className="text-xl md:text-2xl font-bold text-foreground mb-2">Property Highlights</h4>
                    <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                      Comprehensive property information with structured highlights, making key details scannable at a
                      glance
                    </p>
                  </div>
                </div>
          ...
          <div className="container mx-auto max-w-[90%] lg:max-w-[1440px]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div className="order-1 lg:order-2 space-y-6">
                <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground">Responsive Layout</h3>
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                  The property details experience was designed to adapt seamlessly across all device sizes. From tablet
                  to mobile, every interaction remains intuitive and accessible.
                </p>
                <ul className="space-y-4 text-muted-foreground">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <strong className="text-foreground">Adaptive Gallery</strong> — Full-screen image carousel
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <strong className="text-foreground">Responsive Typography</strong> — Content hierarchy adjusts for
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <strong className="text-foreground">Contact Integration</strong> — Streamlined inquiry flow with
                      persistent agent contact options
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <span>
                      <strong className="text-foreground">Feature Parity</strong> — All desktop functionality preserved
        ...
        <section
          ref={resultsAnim.ref}
          className={`min-h-screen flex items-center justify-center py-10 md:py-24 transition-all duration-700 ${resultsAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          <div className="container mx-auto max-w-[1440px] text-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              ...
              <div className="bg-card rounded-2xl p-8 shadow-sm space-y-3 md:space-y-4 text-left">
                ...
                <p className="text-sm md:text-base text-muted-foreground mb-4">Post-launch user satisfaction score.</p>
                <div className="text-4xl md:text-5xl font-bold bg-gradient-primary bg-clip-text text-transparent">
                  92%
                </div>
              </div>
        ...
        <section
          ...
          className={`min-h-screen flex items-center justify-center py-12 md:py-24 bg-card/30 transition-all duration-700 ${showcaseAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          <div className="container mx-auto max-w-[1600px] space-y-6 md:space-y-12">
            ...
            <div className="w-full rounded-xl md:rounded-2xl overflow-hidden shadow-glow">
              <img
                src={landDetails3up}
                alt="Property details page on multiple devices"
                className="w-full h-full object-cover"
              />
            </div>
          </div>
        ...
        <section
          ref={navigationAnim.ref}
          className={`py-24 border-t border-border transition-all duration-700 ${navigationAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          <div className="container mx-auto max-w-[1440px]">
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-50 flex gap-2 bg-background/20 backdrop-blur-md p-3 rounded-full">
              {galleryImages.map((img, idx) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all ${idx === currentImageIndex ? "bg-primary w-8" : "bg-muted-foreground/40 hover:bg-muted-foreground/60"}`}
                />
              ))}
            </div>
          </div>
