        ...
        <div className="container mx-auto max-w-6xl">
          <div className="space-y-6 mb-12 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl">
              A modern banking experience with intuitive navigation and seamless transactions. 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6 animate-fade-in">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                This project aimed to revolutionize the mobile banking experience by creating 
                an intuitive, secure, and visually appealing interface. The challenge was to 
                simplify complex financial operations while maintaining the highest security 
                standards.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
